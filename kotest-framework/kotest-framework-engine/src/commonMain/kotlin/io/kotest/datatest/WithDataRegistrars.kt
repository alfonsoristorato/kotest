...
abstract class WithDataRegistrar {
   abstract fun registerWithDataTest(name: String, test: suspend TestScope.() -> Unit)
   abstract suspend fun registerSuspendWithDataTest(name: String, test: suspend TestScope.() -> Unit)
   enum class Scope {
      CONTAINER,
      TEST
   }
